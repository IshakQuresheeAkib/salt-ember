...
const buttonVariants: Record<ButtonVariant, string> = {
  primary:
    "gap-[clamp(9px,1.5vw,22px)] bg-silver text-midnight-shadow transition-[transform,scale,background] duration-200 hover:-translate-y-0.5 hover:bg-orange active:scale-[0.97]",
  secondary:
    "border border-silver text-silver transition-colors duration-200 hover:bg-orange hover:text-midnight-shadow",
  text: "p-0 text-silver underline decoration-orange underline-offset-4 transition-colors duration-200 hover:text-orange",
};
